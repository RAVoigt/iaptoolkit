...
class OIDC(BaseTokenInterface):
    ...
    def __init__(self, iap_client_id, validate_iap_client_id: bool = False) -> None:
        super().__init__(
    ...
    def _get_fresh_token(self) -> TokenStruct:
        google_credentials = OIDC._get_fresh_credentials(self._iap_client_id)
    ...
    def get_token(self, iap_client_id: str, bypass_cached: bool = False, attempts: int = 0) -> TokenStruct:
        ...
        try:
            ...
            if use_cache and token_struct:
                token_struct.from_cache = True
            else:
                token_struct = self._get_fresh_token()
                token_struct.from_cache = False
